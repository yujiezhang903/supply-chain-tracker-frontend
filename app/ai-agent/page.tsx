  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (data.sessionId) {
        ...
        localStorage.setItem('ai-agent-session-id', data.sessionId);
      }
